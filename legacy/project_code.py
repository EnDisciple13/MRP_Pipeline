...
def calculate_alpha_health(df_alpha):
    ...
    # Capital commitment must include both Firmed POs and future planned POs
...
def execute_calendar_join(df_alpha, df_beta):
    ...
    # Action Delta is strictly driven by human intervention (POs placed).
