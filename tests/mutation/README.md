...
Theory: Notes `meta/rigor/Invariant_Authorship.md` §VI.2 (drills, kill rate) and §VIII (mechanical anchor role). Plan: Notes `inbox/2026-07-04-invariant-loop-plan.md` §II.2.
